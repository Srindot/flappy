...
# Verified for DART 6.1.2 + PyDART2 0.3.11 + Gym 0.17.3
# ------------------------------------------------------------------
FROM ubuntu:16.04
...
# ------------------------------------------------------------------
# 0. Redirect to old Ubuntu 16.04 (EOL) repositories
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# 4. Build PyDART2 against installed DART (verified configuration)
# ------------------------------------------------------------------
RUN python3 -m pip install --no-cache-dir pydart2==0.3.11

# ------------------------------------------------------------------
# 5. Simulation + Reinforcement Learning Dependencies
# ------------------------------------------------------------------
