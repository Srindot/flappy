...
# ------------------------------------------------------------------
# 2. Modern pip toolchain still supporting Python 3.5
# ------------------------------------------------------------------
RUN python3 -m pip install --upgrade "pip==20.3.4" "setuptools<45" "wheel<0.34"

# ------------------------------------------------------------------
# 3. Build and install DART v6.1.2  (PyDART2 tested compatible)
# ------------------------------------------------------------------
WORKDIR /opt
...
# ------------------------------------------------------------------
# 6. Default work directory and environment
# ------------------------------------------------------------------
WORKDIR /workspace
